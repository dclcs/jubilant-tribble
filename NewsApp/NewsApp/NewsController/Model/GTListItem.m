...
-(nullable instancetype)initWithCoder:(NSCoder *)coder{
    ...
    if (self) {
        ...
        self.articaleUrl = [coder decodeObjectForKey:@"articaleUrl"];
    }
    return self;
}
...
-(void)encodeWithCoder:(NSCoder *)coder{
    ...
    [coder encodeObject:self.articaleUrl forKey:@"articaleUrl"];
}
...
# warning 类型是否匹配
    ...
    self.articaleUrl = [dictionary objectForKey:@"url"];
}
@end
